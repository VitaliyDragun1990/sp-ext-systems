package com.revenat.ext.network.server.config;

import com.revenat.ext.network.server.RequestHandlersProvider;
...
public class Config {
    ...
    private static Properties loadFromFile(final String configFileName) {
        ...
        try {
            props.load(requireNonNull(RequestHandlersProvider.class.getClassLoader().getResourceAsStream(configFileName)));
